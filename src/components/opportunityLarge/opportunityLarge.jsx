...
const OpportunityLarge = () => {
  ...
  return (
    ...
    <div className="lg:m-10 m-4 p-2 lg:p-6 border border-secondary rounded-lg shadow-md bg-accent flex flex-col lg:max-w-5xl">
      ...
      <p className="text-lg mt-2 flex justify-between items-center">
        ...
        <div className='hidden lg:flex'>
            <p> 
                <b>Created by: </b>{result.created_by}
            </p>
        </div>
      </p>
      <p className='lg:hidden text-lg' ><b>Created by: </b>{result.created_by}</p>
      ...
      <div className='flex justify-center'>
          <button onClick={()=>window.my_modal_2.showModal()} className="mt-4 bg-primary text-white px-4 py-2 w-full rounded-lg max-w-sm ">
            APPLY NOW
          </button>
