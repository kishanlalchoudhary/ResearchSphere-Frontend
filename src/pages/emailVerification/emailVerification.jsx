        ...
        <div className="w-full lg:w-2/3  bg-accent lg:px-20 px-10">
            <div className='pt-20 lg:pt-20'>
                <div className='lg:p-12'>
                    <h1 className="lg:text-5xl text-3xl font-bold">Email Verification link </h1>
                    <h1 className="lg:text-3xl text-xl font-bold pt-5">Click the button below to verify the account</h1>
                    <div className='p-16 lg:p-5 flex xs:justify-center xs:items-center'>
                        <button onClick="#" className="btn btn-primary text-accent h-12 lg:h-14 text-2xl px-10 lg:px-10">
                            Verify
                        </button>
                    </div>
