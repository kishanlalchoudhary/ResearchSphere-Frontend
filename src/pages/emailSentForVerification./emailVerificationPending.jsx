            ...
            <div className="w-full lg:w-2/3  bg-accent lg:px-20 px-10">
                <div className='pt-10 lg:pt-20'>
                    <div className='lg:p-12'>
                        <h1 className="lg:text-5xl text-3xl font-bold">A Email verification link has been sent to you email ID </h1>
                        <h1 className="lg:text-3xl text-xl font-bold pt-5">Please open the link to activate the account</h1>
