            ...
            <div className="flex flex-col lg:h-[100vh] w-full lg:w-2/5 bg-secondary px-10 lg:pl-20 ">
                ...
                <div className='lg:p-8 h-[60vh] hidden lg:flex lg:flex-col justify-center items-center'>
                    ...
                    <div className='p-4 lg:p-5 '>
                        <button onClick ={handleLoginClick} className="btn btn-primary text-accent h-12 lg:h-12 text-2xl px-10 lg:px-10">LOGIN</button>
                    </div>
                </div>
                ...
                <div className='lg:h-[100vh] flex flex-col justify-center items-center w-full'>
                    <div className="card min-w-full lg:min-w-fit"> 
                        <div className="card-body shadow-2xl bg-accent rounded-lg" >
                            <h1 className="lg:text-3xl text-2xl text-center lg:px-24  font-bold text-primary">Create Your Account</h1>
                            <hr className="border-t-2  w-2/3 mx-auto my-4 lg:my-2" />
                            <div className="form-control lg:px-5">
                                <label className="label">
                                    <span className="label-text text-xl">Name</span>
                                </label>
                                <input type="text" placeholder="Name" className="input input-bordered bg-accent border-primary h-12 lg:h-12" />
                            </div>
                            <div className="form-control lg:px-5">
                                <label className="label">
                                    <span className="label-text text-xl">Email</span>
                                </label>
                                <input type="email" placeholder="Email" className="input input-bordered bg-accent border-primary h-12 lg:h-12" />
                            </div>
                            <div className="form-control lg:px-5">
                                <label className="label">
                                    <span className="label-text text-xl">Password</span>
                                </label>
                                <input type="password" placeholder="Password" className="input input-bordered bg-accent border-primary h-12 lg:h-12" />
                            </div>
                            <div className="form-control lg:px-5">
                                <label className="label">
                                    <span className="label-text text-xl">Confirm Password</span>
                                </label>
                                <input type="password" placeholder="Confirm Password" className="input input-bordered bg-accent border-primary h-12 lg:h-12" />
                            </div>
                            <div className="form-control items-center px-10 mt-6">
                                <button onClick={handleEmailClick} className="btn btn-primary text-accent h-12 w-full lg:h-16 text-2xl">REGISTER</button>
                            </div>
                            <div className="form-control lg:hidden items-center px-10">
                                <button onClick={handleLoginClick} className="btn btn-primary btn-outline h-12 w-full lg:h-16 text-2xl">LOGIN</button>
                            </div>
                        </div>
                    </div>
                </div>            
